...
class XTemplate {
	...
	public function setup ($add_outer = false) {
		...
		$this->file_delim = $this->preg_delimiter . $this->tag_start_delim . "INCLUDE\s*\"([^\"]+)\"" . $this->comment_preg . $this->tag_end_delim . $this->preg_delimiter . 'm';

		// regexp for file includes
		$this->filevar_delim = $this->preg_delimiter . $this->tag_start_delim . "INCLUDE\s*" . $this->tag_start_delim . "([A-Za-z0-9\._\x7f-\xff]+?)" . $this->comment_preg . $this->tag_end_delim . $this->comment_preg . $this->tag_end_delim . $this->preg_delimiter . 'm';

		// regexp for file includes w/ newlines
		$this->filevar_delim_nl = $this->preg_delimiter . "^\s*" . $this->tag_start_delim . "INCLUDE\s*" . $this->tag_start_delim . "([A-Za-z0-9\._\x7f-\xff]+?)" . $this->comment_preg . $this->tag_end_delim . $this->comment_preg . $this->tag_end_delim . "\s*\n" . $this->preg_delimiter . 'm';
