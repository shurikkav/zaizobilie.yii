...
?>
<div class="congratulation_details" style="">


    <div class="congratulation_header">
        <div id="ulrubrics" class="congratulation_rubrics">
            <a href="<?= Yii::$app->urlManager->createUrl(['congratulation/']) ?>"><h3>Поздравления</h3></a>
        </div>
    </div>
    ...
    <!--Name-->
    <div class="congratulation_name">
        <h1><?=$data->name;?></h1>
    </div>
    <!--Name-->

    <!--Дата публикации-->
    <div class="congratulation_date">
        <time itemprop="datePublished" datetime="<?=$data->date_start;?>"><?=$data->date_start;?></time>
    </div>
    <!--Дата публикации-->

    <div class="congratulation_text"><?=$data->text;?>
    </div>
