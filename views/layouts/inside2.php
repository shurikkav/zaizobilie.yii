...
<meta name="description" content="За изобилие. Колпнянская районная общественно-политическая газета орловской области.">
<meta name="keywords" content="За изобилие, колпня, колпнянский район, СМИ, газета, новости, орел, область, орловская">
...
</style></head><body><div id="wrapJsiBox" style="position: absolute; top:0; left:0; display: none; z-index: 3000; background-color:#000; opacity: 0.6; filter: alpha(opacity='60');"></div><div style="position: absolute; top: 0; left: 0; width: 100%; z-index: 3001;">  <div id="jsiMainBox" style="color: #fff;text-align:left;position: relative; display: none;margin: auto;z-index: 2;width: 400px; background:#000; border: 0 solid #FFFFFF; padding-bottom: 2px;">  <p style="text-align: right; font: bold 10px Tahoma; padding-top: 0;width:100%;overflow:hidden;padding-bottom:0;">  <img src="/js/img/ajax-loader2.gif" alt="" id="jsiBoxLoading" style="float:left; display:inline; margin:7px 5px 0 8px;"> <a href="#" style="padding:0 20px 0 0;width:28px;line-height:32px;" onclick="return jsiBoxClose();" class="jsiBtn">×</a> <span style="width: 100px; float: left; position:relative; margin: 0 0 0 20px;"> <a href="#" id="nextJsiBoxLink" onclick="return jsiBoxNext();" style="position:absolute;top: 0;right: 0;line-height:30px;" class="jsiBtn">→</a> <a href="#" id="prevJsiBoxLink" onclick="return jsiBoxPrev();" style="position:absolute;top: 0;left: 0;line-height:30px;" class="jsiBtn">←</a>  </span> </p> <p id="jsiBoxNumberOfImage" style="margin: 0 20px;color: #808080;text-align: center;"></p> <div id="jsiBoxMainImageWrap" style="background:#808080; margin: 0 20px 20px 20px; overflow: hidden; position: relative;"> <img src="/js/img/blank.gif" id="jsiBoxMainImage" alt="" style="display: block;"> </div> <span id="jsiBoxTitle" style="margin:0 8px; font: normal 12px;"> </span> </div></div>
							...
							<div class="top_reading">
									...
									<article>
										...
										<div class="article_content">
											<a href="index_article.html">
											<!--Header published-->
											<h2>28 февраля 2013 года 110 школ, 4500 активистов детских общественных объединений из 20 муниципальных образований Амурской области в возрасте от 12 до 17 лет приняли участие в областной сетевой акции «Мы - будущее региона».</h2>
											<!--Header published-->
											</a>
											...
											<footer>
													...
													<div class="stat">
														...
														<div class="view">
															<div class="icon"><img src="/img/Icon_view.svg" alt="Поросмотров:"></div>
															<div class="content wrap_right">8 146</div>
														</div>
														<!--Просмотры-->
									...
									<article>
										...
										<div class="article_content">
											<a href="index_article.html">
											<!--Header published-->
											<h2>Чемпион мира 1998 года Блан: во время ЧМ-2018 Россия станет центром мира</h2>
											<!--Header published-->
											</a>
											...
											<footer>
													...
													<div class="stat">
														...
														<div class="view">
															<div class="icon"><img src="/img/Icon_view.svg" alt="Поросмотров:"></div>
															<div class="content wrap_right">2 376</div>
														</div>
														<!--Просмотры-->
